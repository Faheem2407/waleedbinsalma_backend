            ...
            <form action="{{ route('client_review.update', $review->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mt-4 input-style-1">
                    ...
                    <input type="text" id="shop_name" name="shop_name"
                        ...
                        value="{{ old('shop_name', $review->shop_name) }}" placeholder="Enter User Name" required />
                    @error('shop_name')
                ...
                <div class="mt-4 input-style-1">
                    ...
                    <input type="text" id="shop_location" name="shop_location"
                        ...
                        value="{{ old('shop_location', $review->shop_location) }}" placeholder="Enter User Location" required />
                    @error('shop_location')
                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                    @enderror
                </div>
