...
@section('title', 'CMS | Edit Business Grow Section')
        ...
        <div class="flex-wrap container-fluid d-flex flex-stack flex-sm-nowrap">
            ...
            <div class="flex-wrap d-flex flex-column align-items-start justify-content-center me-2">
                ...
                <ul class="my-1 breadcrumb fw-semibold fs-base">
                    ...
                    <li class="breadcrumb-item text-muted">Edit Business Grow Section</li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="mb-4 card-style">
                    <div class="card card-body">
                        <form method="POST" action="{{ route('businessHome.grow.update', $data->id) }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
