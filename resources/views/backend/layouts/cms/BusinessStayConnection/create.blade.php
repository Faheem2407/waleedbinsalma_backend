...
@section('title', 'CMS | Business Stay Connection Section')
        ...
        <div class="flex-wrap container-fluid d-flex flex-stack flex-sm-nowrap">
            ...
            <div class="flex-wrap d-flex flex-column align-items-start justify-content-center me-2">
                ...
                <ul class="my-1 breadcrumb fw-semibold fs-base">
                    ...
                    <li class="breadcrumb-item text-muted">Business Stay Connection Section</li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                <div class="mb-4 card-style">
                    <div class="card card-body">
                        <form method="POST" action="{{ route('businessHome.stayConnection.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
