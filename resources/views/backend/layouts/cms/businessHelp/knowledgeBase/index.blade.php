...
@section('title', 'Business Help Knowledge Base')
        ...
        <div class="flex-wrap container-fluid d-flex flex-stack flex-sm-nowrap">
            ...
            <div class="flex-wrap d-flex flex-column align-items-start justify-content-center me-2">
                ...
                <ul class="my-1 breadcrumb fw-semibold fs-base">
                    ...
                    <li class="breadcrumb-item text-muted">Business Help Section</li>
    ...
    <div class="container-fluid">
        <div class="card p-5">
            <div class="mb-3 d-flex justify-content-end">
                <a href="{{ route('businessHelp.knowledgeBase.create') }}" class="btn btn-primary"> Add New Section </a>
            </div>
...
@push('script')
    <script>
        $(document).ready(function() {
            if (!$.fn.DataTable.isDataTable('#data-table')) {
                $('#data-table').DataTable({
                    ...
                    serverSide: true,
                    responsive: true,
                    ajax: "{{ route('businessHelp.knowledgeBase.index') }}",
                    columns: [
            ...
            $(document).on('click', '.delete', function() {
                ...
                const url = "{{ route('businessHelp.knowledgeBase.destroy', ':id') }}".replace(':id', id);
        ...
        function statusChange(id) {
            let url = '{{ route('businessHelp.knowledgeBase.status', ':id') }}'.replace(':id', id);
            $.ajax({
                type: "GET",
                url: url,
        ...
        function deleteItem(id) {
            let url = '{{ route('businessHelp.knowledgeBase.destroy', ':id') }}';
