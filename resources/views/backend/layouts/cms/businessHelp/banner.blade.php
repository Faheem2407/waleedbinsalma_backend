...
@section('title', 'Business Help Banner')
        ...
        <div class=" container-fluid  d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                ...
                <h1 class="text-dark fw-bold my-1 fs-2">
                    Business Help Banner <small class="text-muted fs-6 fw-normal ms-1"></small>
                </h1>
                <!--end::Title-->
            ...
            <div class="col-lg-12">
                <div class="card-style mb-4">
                    <div class="card card-body">
                        <form method="POST" action="{{ route('admin.cms.businessHelp.banner.update') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
