...
@section('title', 'Business Pricing FAQ | CMS')
    ...
    <div class="container-fluid">
        <div class="card p-5">
            <div class="mb-3 d-flex justify-content-end">
                <a href="{{ route('businessPricing.faq.create') }}" class="btn btn-primary"> Add New Section </a>
            </div>
...
@push('script')
    <script>
        $(document).ready(function() {
            if (!$.fn.DataTable.isDataTable('#data-table')) {
                $('#data-table').DataTable({
                    ...
                    serverSide: true,
                    responsive: true,
                    ajax: "{{ route('businessPricing.faq.index') }}",
                    columns: [
            ...
            $(document).on('click', '.delete', function() {
                ...
                const url = "{{ route('businessPricing.faq.destroy', ':id') }}".replace(':id', id);
        ...
        function statusChange(id) {
            let url = '{{ route('businessPricing.faq.status', ':id') }}'.replace(':id', id);
            $.ajax({
                type: "GET",
                url: url,
        ...
        function deleteItem(id) {
            let url = '{{ route('businessPricing.faq.destroy', ':id') }}';
