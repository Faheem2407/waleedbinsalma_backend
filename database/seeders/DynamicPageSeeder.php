    ...
    public function run(): void
    {
        DynamicPage::insert([
            ...
            [
                ...
                "page_content" => "This is the terms of service content. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus facilisis semper orci, vitae ullamcorper nulla dictum at. Nullam vulputate nunc ac lectus dignissim, a facilisis eros scelerisque. Morbi hendrerit, ligula nec cursus fermentum, risus libero pretium justo, non porttitor nulla velit ac nunc. Aenean ac libero ut lorem pretium aliquam non non ex. Etiam a fringilla tellus, nec volutpat est.",
            ],
            [
                "page_title" => "Terms of Use",
                "page_slug" => "terms-of-use",
                "page_content" => "This is the terms of use content. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit.",
            ]
        ]);
    }
}
